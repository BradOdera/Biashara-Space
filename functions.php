...
function theme_enqueue_scripts() {
        wp_enqueue_style( 'Font_Awesome', 'https://use.fontawesome.com/releases/v5.13.0/css/all.css' );
        ...
        wp_enqueue_script( 'javascript', get_template_directory_uri() . '/js/navbar.js', array(), true );
        }
